<template>
    <v-card style="width:450px; height:100%;" outlined>
        ...
        <v-card-text style="background-color: white;">
            ...
            <String label="Participants" v-model="value.participants" :editMode="editMode" :inputUI="''"/>
            ...
            <Date label="LastMessageTime" v-model="value.lastMessageTime" :editMode="editMode" :inputUI="''"/>
        </v-card-text>
